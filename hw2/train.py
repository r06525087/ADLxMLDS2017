...
def main():
	...
	parser.add_argument('--train_label_json', type=str, default='MLDS_hw2_data/training_label.json',
						help='directory to store checkpointed models')
	parser.add_argument('--test_label_json', type=str, default='MLDS_hw2_data/testing_label.json',
						help='directory to store checkpointed models')
	...
	parser.add_argument('--gpu_mem', type=float, default=0.900,
						help='% of gpu memory to be allocated to this process. Default is 80%')
	parser.add_argument('--log_dir', type=str, default='log',
						help='directory containing log text')
	parser.add_argument('--schedule_sampling', type=float, default=0.01,
